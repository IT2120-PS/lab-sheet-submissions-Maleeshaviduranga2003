setwd("C:\\Users\\IT24100869\\Desktop\\IT2410869")
...
histogram<- hist(X1,main="Histogram for Delivery Times" , xlab = "Delivery Time",breaks = seq(20,70,length = 10),right = FALSE)
